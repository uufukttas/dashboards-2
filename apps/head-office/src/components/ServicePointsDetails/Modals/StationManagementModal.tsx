...
const StationManagementModal: React.FC<{ unitCode: number; connectorNumber: number }> = ({
  unitCode,
  connectorNumber,
}: {
  unitCode: number;
    ...
    >
      <div className={`${BRAND_PREFIX}-${sectionPrefix}-modal-form-container relative p-6 bg-white rounded-lg`}>
        <form className={`${BRAND_PREFIX}-${sectionPrefix}-form w-full`} onSubmit={() => {}}>
          ...
          <div
            className={`${BRAND_PREFIX}-${sectionPrefix}-station-actions-contaier flex justify-between items-center flex-col`}
          >
            <div
              className={`${BRAND_PREFIX}-${sectionPrefix}-station-actions-container flex justify-between items-center w-full`}
            >
              <div className={`${BRAND_PREFIX}-${sectionPrefix}-station-refresh-actions-container`}>
                ...
                />
                <div
                  className={`${BRAND_PREFIX}-${sectionPrefix}-station-refresh-input-container flex justify-between items-center`}
                >
                  <Dropdown
                    ...
                    onClick={() => {
                      const response = axios.post(
                        'http://192.168.3.75:91/DeviceOperation/ResetDevice',
                        {
                          ...
                          reset:
                            formData.refresh === 'Secim Yapiniz' || formData.refresh === '' ? 'Hard' : formData.refresh,
                          companyId: 2,
                        },
              ...
              <div
                className={`${BRAND_PREFIX}-${sectionPrefix}-connector-lock-action-container flex justify-between items-center flex-col`}
              >
                <Label
                ...
                />
                <div
                  className={`${BRAND_PREFIX}-${sectionPrefix}-connector-lock-input-container flex justify-between items-center`}
                >
                  <Button
            ...
            <div
              className={`${BRAND_PREFIX}-${sectionPrefix}-station-actions-container flex justify-between items-center w-full my-4`}
            >
              <div className={`${BRAND_PREFIX}-${sectionPrefix}-connector-status-container`}>
                <div className={`${BRAND_PREFIX}-${sectionPrefix}-connector-status`}>
                  ...
                  />
                  <div
                    className={`${BRAND_PREFIX}-${sectionPrefix}-connector-status-input-container flex justify-between items-center`}
                  >
                    <Dropdown
              ...
              <div
                className={`${BRAND_PREFIX}-${sectionPrefix}-connector-charge-notification-container flex justify-between items-end flex-col`}
              >
                <Label
                ...
                />
                <div
                  className={`${BRAND_PREFIX}-${sectionPrefix}-connector-charge-notification-input-container flex justify-between items-center`}
                >
                  <Dropdown
          ...
          <hr className={`${sectionPrefix}-header-line w-full my-4`} />
          <div
            className={`${BRAND_PREFIX}-${sectionPrefix}-station-user-actions-container flex justify-between items-start flex-col w-full`}
          >
            <Label
            ...
            />
            <div
              className={`${BRAND_PREFIX}-${sectionPrefix}-station-user-phone-number-input-container flex justify-between items-center w-full`}
            >
              <Input
            ...
            <div
              className={`${BRAND_PREFIX}-${sectionPrefix}-station-user-actions-container flex justify-start items-center w-full my-4`}
            >
              <Button
