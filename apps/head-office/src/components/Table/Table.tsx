...
return (
  <div className="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
    ...
    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 shadow-custom">
              ...
              <>
                <tr key={index}>
                  ...
                  <td className="px-6 py-4">
                    <a data-modal-show="editUserModal" data-user-id={user.Id} className="font-medium text-blue-600 dark:text-blue-500 hover:underline" onClick={getUpdatedUserInfo}>Edit user</a>
                  </td>
                  <td className="px-6 py-4">
                    <Button type="button" data-modal-show="editUserModal" className="font-medium text-blue-600 dark:text-blue-500" onClick={() => { toggleTableRow() }}>&#11206;</Button>
                  </td>
                </tr>
