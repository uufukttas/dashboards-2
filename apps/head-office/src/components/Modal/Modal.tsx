...
const Modal = ({ children, modalId }: IModalProps) => {
  ...
  return (
    <div aria-hidden='true' className={`sh-service-point-modal-container flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-40 justify-center items-center w-full md:inset-0 bg-[#54565a33] block h-full`} id={modalId} tabIndex={-1} >
