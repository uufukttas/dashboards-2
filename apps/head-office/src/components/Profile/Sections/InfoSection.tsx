...
const InfoSection: React.FC = () => {
  ...
  const handlePushModal = () => {
    openModal(
      'modal',
      <ModalLayout name="modal" title="Demo Modal">
        <div>
          <h3>This is thr</h3>
        </div>
      </ModalLayout>,
  ...
  return (
    <div className={`${profilePagePrefix}-info-container flex justify-between items-center`}>
      ...
      <Button id="dsa" type="button" buttonText="Open Modal" onClick={handlePushModal}></Button>
      <div
        className={`${profilePagePrefix}-background-image-container text-black w-1/3 text-center flex justify-center items-center`}
      >
