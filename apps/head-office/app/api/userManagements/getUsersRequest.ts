...
const getUsersRequest = async (
  payload: IGetUsersRequestPayloadProps
): Promise<IGetUsersManagementUsersResponseProps> => {
  try {
    const response = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/Auh/Users` || '', payload, {
