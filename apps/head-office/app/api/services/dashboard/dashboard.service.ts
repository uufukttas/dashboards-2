...
import { DashboardComponentInfoRequest, DashboardItem, DashboardItemDataRequest } from './dashboard.interface';
...
export const { useGetDashboardComponentInfoQuery, useGetDashboardItemsMutation } = dashboardService;
